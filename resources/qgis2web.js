...
map.getView().fit([9802164.664686, 2438033.204240, 9951101.188848, 2525980.344054], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CREEK DENSITY 2009</h2>';
        return titleElement;
    })(),
